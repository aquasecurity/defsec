...
require (
	...
	github.com/elgohr/go-localstack v0.0.0-00010101000000-000000000000
...
replace github.com/elgohr/go-localstack => github.com/aquasecurity/go-localstack v0.0.0-20220705131018-617cb0501c72
