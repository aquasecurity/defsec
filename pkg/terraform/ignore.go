...
func (ignores Ignores) Covering(modules Modules, m types2.Metadata, workspace string, ids ...string) *Ignore {
...
func (ignore Ignore) Covering(modules Modules, m types2.Metadata, workspace string, ids ...string) bool {
...
func (ignore Ignore) MatchParams(modules Modules, blockMetadata *types2.Metadata) bool {
