...
func New(opts ...options.ScannerOption) *Scanner {
	...
	s.parser = parser2.New(options.ParserWithSkipRequiredCheck(s.skipRequired))
	return s
}
...
func (s *Scanner) scanFileContext(ctx context.Context, regoScanner *rego.Scanner, cfCtx *parser2.FileContext, fs fs.FS) (results scan.Results, err error) {
