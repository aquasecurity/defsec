...
var terraformEnableLocalDiskEncryptionGoodExamples = []string{
	`
...
var terraformEnableLocalDiskEncryptionBadExamples = []string{
	`
...
var terraformEnableLocalDiskEncryptionLinks = []string{
	`https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/emr_security_configuration`,
}

var terraformEnableLocalDiskEncryptionRemediationMarkdown = ``
