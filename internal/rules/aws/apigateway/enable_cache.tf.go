...
var terraformEnableCacheGoodExamples = []string{
	`
...
var terraformEnableCacheBadExamples = []string{
	`
 resource "aws_api_gateway_rest_api" "example" {
