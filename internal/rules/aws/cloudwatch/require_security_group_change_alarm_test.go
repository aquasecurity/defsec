	...
	}{
		{
			...
			cloudwatch: cloudwatch.CloudWatch{
				LogGroups: []cloudwatch.LogGroup{
					{
						...
						MetricFilters: []cloudwatch.MetricFilter{
							{
								Metadata:   types2.NewTestMetadata(),
								FilterName: types2.String("SecurityGroupChange", types2.NewTestMetadata()),
								FilterPattern: types2.String(`{($.eventName=AuthorizeSecurityGroupIngress) || 
					...
					($.eventName=DeleteSecurityGroup)}`, types2.NewTestMetadata()),
							},
						},
					},
				},
				Alarms: []cloudwatch.Alarm{
					{
						Metadata:   types2.NewTestMetadata(),
						AlarmName:  types2.String("SecurityGroupChange", types2.NewTestMetadata()),
						MetricName: types2.String("SecurityGroupChange", types2.NewTestMetadata()),
						Metrics: []cloudwatch.MetricDataQuery{
							{
								Metadata: types2.NewTestMetadata(),
								ID:       types2.String("SecurityGroupChange", types2.NewTestMetadata()),
							},
						},
					},
				},
