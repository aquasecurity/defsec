...
#   service:EC2
#   severity: LOW
#   short_code: overlapping-security-groups 
#   recommended_action: "Structure security groups to provide a single category of access and do not duplicate rules across groups used by the same instances."
#   input:
#     selector:
#      - type: cloud
