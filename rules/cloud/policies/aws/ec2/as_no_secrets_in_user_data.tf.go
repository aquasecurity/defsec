...
var terraformASNoSecretsInUserDataBadExamples = []string{
	`
...
var terraformASNoSecretsInUserDataLinks = []string{
	`https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/instance#user_data`,
}

var terraformASNoSecretsInUserDataRemediationMarkdown = ``
